...
class TaskItem extends Component {
  ...
  render(){ 
    return (
      ...
      <td>{this.props.task.note}</td>
      <td>{this.props.task.customer}</td>
      <td>{this.props.task.tour}</td>
      <td>{this.props.task.customer_id}</td>
      <td>{this.props.task.tour_id}</td>
      <td>{this.props.task.category_id}</td>
      <td>{this.props.task.user_id}</td>      
